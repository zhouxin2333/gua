...
public interface RunActionHandler<T extends Element, R extends Action> {

    default String type() {
        Type[] actualTypeArguments = RefectionUtils.getActualTypeArguments(this.getClass(), RunActionHandler.class);
